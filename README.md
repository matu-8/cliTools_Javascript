 ...
 **Object.entries**: Es un metodo del tipo de dato objeto, el cual permite convertir un objeto a un arreglo con las propiedades pasadas a pares de clave-valor.  
 ![Captura de pantalla de la consola en visual studio code mostrando la salida de un console.log con el tipo de dato que corresponde al arreglo.](C:\Users\aguer\OneDrive\Pictures\screenshots\CLI1.png)
>[!NOTE]
